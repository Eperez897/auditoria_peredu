...
## Ubicación y justificación de cada vulnerabilidad

### SQL Injection — Probabilidad 5 (Muy alta) × Impacto 5 (Catastrófico) = 25 — Crítico
...
### Command Injection — Probabilidad 4 (Alta) × Impacto 5 (Catastrófico) = 20 — Crítico
...
### XSS Reflejado — Probabilidad 4 (Alta) × Impacto 3 (Moderado) = 12 — Alto
...
## Priorización final (coherente con CVSS)
